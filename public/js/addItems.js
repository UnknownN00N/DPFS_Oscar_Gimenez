document.addEventListener('DOMContentLoaded', () => {
    ...
    toggleButton.addEventListener('click', () => {
      // Aquí solo ocultamos los elementos relacionados con el contenido
    ...
    selectButton.addEventListener('click', () => {
      ...
      // Mostrar contenido relacionado, si es necesario
      // Aquí podrías agregar el comportamiento que necesites al hacer clic en este botón
    });
